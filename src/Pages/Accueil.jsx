  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-green-50 to-blue-50 py-12">
      <div className="container mx-auto px-4">
        ...
        <div className="mt-16 max-w-4xl mx-auto bg-white rounded-2xl shadow-2xl p-8 md:p-12 text-center animate-slideUp">
          <h2 className="text-3xl md:text-4xl font-bold text-gray-800 mb-4">Vous souhaitez vous impliquer ?</h2>
          <p className="text-xl text-gray-600 mb-8">
            Chaque talent est précieux ! Rejoignez une ou plusieurs commissions et mettez vos dons au service de la
            communauté.
          </p>
          <a
            href="#rejoindre"
            className="inline-block bg-gradient-to-r from-green-500 to-blue-500 text-white px-8 py-4 rounded-lg font-bold hover:shadow-lg transition-all duration-300 transform hover:scale-105"
          >
            Contactez-nous
          </a>
        </div>
